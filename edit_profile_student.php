  ...
  <body>
   ...
   <div class="container">
     ...
     <form class="edit" action="edit_profile_student_confirm.php" method="POST">
       <label class="form-group" for="fname">Edit Student's First Name</label>
       <input type="text" name="fname" placeholder="Enter Firstname" required> <br>
       <label class="form-group" for="lname">Edit Student's Last Name</label>
       <input type="text" name="lname" placeholder="Enter Lastname" required> <br>
       <?php echo '<input type="hidden" name="oldemail" value="'.$stdemail.'">';?>
       <label class="form-group" for="email">Edit Student's Email</label>
