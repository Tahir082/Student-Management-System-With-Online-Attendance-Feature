...
<html lang="en" dir="ltr">
  <head>
    <title>Red Academy|Manage Courses</title>
  ...
  <body>
   ...
   <div class="container">
     <div class="row">
       <div class="col-md-4">
         <div class="middle">
           <img src="photos/add.png" alt="Courses" height="100">
            <h3><a href="add_courses.php"> Add Courses</a></h3>
         </div>
       </div>
       <div class="col-md-4">
         <div class="middle">
           <img src="photos/assignteacher.png" alt="Students" height="100">
           <h3><a href="teacher_assign_course.php"> Assign Teachers to Courses</a></h3>
         </div>
       </div>
       <div class="col-md-4">
         <div class="middle">
           <img src="photos/remove.png" alt="Teacher" height="100">
           <h3><a href="delete_courses.php">Show & Edit Courses</a></h3>
         </div>
       </div>
     </div>
   </div>
